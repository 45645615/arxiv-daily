...
const { ARXIV_TERM, SUNARXIV_QUERY, SATARXIV_QUERY, ARXIV_QUERY, MAX_PAPER_COUNT} = require('./template');
...
function sortStringArrayByScore(stringArray, scoreArray) {
    ...
    function compare(a, b) {
      return scoreArray[stringArray.indexOf(a)] - scoreArray[stringArray.indexOf(b)];
    }
